...
return array(
    ...
    //	后台
    'ADMIN_LOGIN_FORM' => '登录系统后台',
    'ADMIN_ACCOUNT_NAME' => 'Account name:',
    'ADMIN_ACCOUNT_PASSWORD' => 'Password:',
    'ADMIN_LOGIN' => 'Login',
    'ADMIN_COPYRIGHT' => '&copy; COPYRIGHT <a href="http://soulpu.com/" target="_blank">SOULPU.COM Ltd.</a>',
    'ADMIN_VALIDATE_USERNAME' => '用户名称必须填写',
    'ADMIN_LOGIN_ERROR' => '用户名和密码是必须填写的',
);
?>